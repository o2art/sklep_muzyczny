<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Produkty.aspx.cs" Inherits="Shop.Produkty" %>
    ...
    <form id="form2" runat="server" class="container">
        <div>
            <table align="center" class="auto-style1 " style="font-family: 'Adobe Fangsong Std R'; background-color: darkgray">
                ...
                <tr>
                    <td colspan="4" class="auto-style4 polecane" style="color: #FFFFFF; background-color: black">
                        <br />
                        <asp:Label ID="lPolecane" runat="server" Font-Size="X-Large" Text="Wszystkie"></asp:Label>
                        <br />
                        <br />
                    </td>
